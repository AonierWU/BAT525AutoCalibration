                            ...
                            if (!HasValueGreaterThanThreshold(VoltItems, nameToValueMap[SplitItems[1]]))
                            {
                                ...
                                for (int num = 0; num < VoltItems.Length; num++)
                                {
                                    for (int loop = 0; loop < Convert.ToInt16(SplitItems[3]); loop++)
                                    {
                                        ...
                                        checkTest.ReadVoltage(testinfo.DeviceType, testinfo.BoxNum, Convert.ToInt32(VoltItems[num]), testinfo.JudgeRegulation, testinfo.TestAcc.ChgVolChkAcc, out TestStatus[num]);
                            ...
                            if (!HasValueGreaterThanThreshold(CurItems, nameToValueMap[SplitItems[1]]))
                            {
                                ...
                                for (int num = 0; num < CurItems.Length; num++)
                                {
                                    ...
                                    for (int loop = 0; loop < Convert.ToInt16(SplitItems[3]); loop++)
                                    {
                                        ...
                                        ShowLog("循环" + (loop + 1) + "设备测试中...");
                                        checkTest.ReadDsgCurrent(testinfo.DeviceType, testinfo.BoxNum, "放电电流3A点检", Convert.ToInt32(CurItems[num]), testinfo.ResType, false, false, testinfo.JudgeRegulation, testinfo.TestAcc.DsgCur3AChkAcc, out TestStatus[num]);
                                        ShowLog("循环" + (loop + 1) + "设备测试结束");
                                        ShowProgress(pb);
                                        //if (TestStatus[num])
                                        //{
                            ...
                            if (!HasValueGreaterThanThreshold(IDRItems, nameToValueMap[SplitItems[1]]))
                            {
                                ...
                                for (int num = 0; num < IDRItems.Length; num++)
                                {
                                    ...
                                    for (int loop = 0; loop < Convert.ToInt16(SplitItems[3]); loop++)
                                    {
                                        ...
                                        ShowLog("循环" + (loop + 1) + "设备测试中...");
                                        checkTest.ReadATR(testinfo.DeviceType, testinfo.BoxNum, SplitItems[1], Convert.ToInt32(IDRItems[num]), ResAcc, CutRange, out TestStatus[num]);
                                        ShowLog("循环" + (loop + 1) + "设备测试结束");
                                        ShowProgress(pb);
                                    }
                                ...
                                else
                                {
                                    for (int num = 0; num < ACIRItems.Length; num++)
                                    {
                                        ...
                                        for (int loop = 0; loop < Convert.ToInt16(SplitItems[3]); loop++)
                                        {
                                            ...
                                            checkTest.ReadACIR(testinfo.DeviceType, testinfo.BoxNum, "直流内阻点检", Convert.ToInt32(ACIRItems[num]), testinfo.TestAcc.DCIRChkAcc, EqmCurValue, CutRange, out TestStatus[num]);
                            ...
                            if (!HasValueGreaterThanThreshold(CurItems, nameToValueMap[SplitItems[1]]))
                            {
                                ...
                                for (int num = 0; num < CurItems.Length; num++)
                                {
                                    ...
                                    for (int loop = 0; loop < Convert.ToInt16(SplitItems[3]); loop++)
                                    {
                                        ...
                                        ShowLog("循环" + (loop + 1) + "设备测试中...");
                                        checkTest.ReadDsgCurrent(testinfo.DeviceType, testinfo.BoxNum, "放电电流30A点检", Convert.ToInt32(CurItems[num]), testinfo.ResType, true, testinfo.ExtRes, testinfo.JudgeRegulation, testinfo.TestAcc.DsgCur30AChkAcc, out TestStatus[num]);
                                        ShowLog("循环" + (loop + 1) + "设备测试结束");
                                        ShowProgress(pb);
                                        //if (TestStatus[num])
                                        //{
                            ...
                            if (!HasValueGreaterThanThreshold(SMCItems, nameToValueMap[SplitItems[1]]))
                            {
                                ...
                                for (int num = 0; num < SMCItems.Length; num++)
                                {
                                    ...
                                    for (int loop = 0; loop < Convert.ToInt16(SplitItems[3]); loop++)
                                    {
                                        ...
                                        ShowLog("循环" + (loop + 1) + "设备测试中...");
                                        checkTest.ReadProVoltage(testinfo.DeviceType, testinfo.BoxNum, "编程电压点检", Convert.ToInt32(SMCItems[num]), testinfo.JudgeRegulation, testinfo.TestAcc.PrgVolChkAcc, CutRange, out TestStatus[num]);
                                        ShowLog("循环" + (loop + 1) + "设备测试结束");
                                        ShowProgress(pb);
                                        //if (TestStatus[num])
                                        //{
                            ...
                            if (!HasValueGreaterThanThreshold(SMCItems, nameToValueMap[SplitItems[1]]))
                            {
                                ...
                                for (int num = 0; num < SMCItems.Length; num++)
                                {
                                    ...
                                    for (int loop = 0; loop < Convert.ToInt16(SplitItems[3]); loop++)
                                    {
                                        ...
                                        checkTest.ReadStaticCurrent(testinfo.DeviceType, testinfo.BoxNum, SplitItems[1], Convert.ToInt32(SMCItems[num]), StcCurAcc, CutRange, out TestStatus[num]);
                            ...
                            if (!HasValueGreaterThanThreshold(SMCItems, nameToValueMap[SplitItems[1]]))
                            {
                                ...
                                for (int num = 0; num < SMCItems.Length; num++)
                                {
                                    ...
                                    for (int loop = 0; loop < Convert.ToInt16(SplitItems[3]); loop++)
                                    {
                                        ...
                                        checkTest.ReadStaticCurrent(testinfo.DeviceType, testinfo.BoxNum, SplitItems[1], Convert.ToInt32(SMCItems[num]), testinfo.TestAcc.StCur_20000nAChkAcc, CutRange, out TestStatus[num]);
                            ...
                            if (!HasValueGreaterThanThreshold(SMCItems, nameToValueMap[SplitItems[1]]))
                            {
                                ...
                                for (int num = 0; num < SMCItems.Length; num++)
                                {
                                    ...
                                    for (int loop = 0; loop < Convert.ToInt16(SplitItems[3]); loop++)
                                    {
                                        ...
                                        checkTest.ReadStaticCurrent(testinfo.DeviceType, testinfo.BoxNum, SplitItems[1], Convert.ToInt32(SMCItems[num]), testinfo.TestAcc.StCur_2000nAChkAcc, CutRange, out TestStatus[num]);
                            ...
                            if (!HasValueGreaterThanThreshold(SMCItems, nameToValueMap[SplitItems[1]]))
                            {
                                ...
                                for (int num = 0; num < SMCItems.Length; num++)
                                {
                                    ...
                                    for (int loop = 0; loop < Convert.ToInt16(SplitItems[3]); loop++)
                                    {
                                        ...
                                        checkTest.ReadCNT(testinfo.DeviceType, testinfo.BoxNum, Convert.ToInt32(SMCItems[num]), SplitItems[1], testinfo.TestAcc.CNTCurPChkAcc, CellVolDMMValue, out TestStatus[num]);
                            ...
                            if (!HasValueGreaterThanThreshold(SMCItems, nameToValueMap[SplitItems[1]]))
                            {
                                ...
                                for (int num = 0; num < SMCItems.Length; num++)
                                {
                                    ...
                                    for (int loop = 0; loop < Convert.ToInt16(SplitItems[3]); loop++)
                                    {
                                        ...
                                        checkTest.ReadCNT(testinfo.DeviceType, testinfo.BoxNum, Convert.ToInt32(SMCItems[num]), SplitItems[1], testinfo.TestAcc.CNTCurNChkAcc, CellVolDMMValue, out TestStatus[num]);
                            ...
                            if (!HasValueGreaterThanThreshold(SMCItems, nameToValueMap[SplitItems[1]]))
                            {
                                ...
                                for (int num = 0; num < SMCItems.Length; num++)
                                {
                                    ...
                                    for (int loop = 0; loop < Convert.ToInt16(SplitItems[3]); loop++)
                                    {
                                        ...
                                        ShowLog("循环" + (loop + 1) + "设备测试中...");
                                        checkTest.ReadPinVoltage(testinfo.DeviceType, testinfo.BoxNum, Convert.ToInt32(SMCItems[num]), "OCV", testinfo.JudgeRegulation, testinfo.TestAcc.OcvVolChkAcc, out TestStatus[num]);
                                        ShowLog("循环" + (loop + 1) + "设备测试结束");
                                        ShowProgress(pb);
                                        //if (TestStatus[num])
                                        //{
                            ...
                            if (!HasValueGreaterThanThreshold(SMCItems, nameToValueMap[SplitItems[1]]))
                            {
                                ...
                                for (int num = 0; num < SMCItems.Length; num++)
                                {
                                    ...
                                    for (int loop = 0; loop < Convert.ToInt16(SplitItems[3]); loop++)
                                    {
                                        ...
                                        ShowLog("循环" + (loop + 1) + "设备测试中...");
                                        checkTest.ReadCellVoltage(testinfo.DeviceType, testinfo.BoxNum, Convert.ToInt32(SMCItems[num]), testinfo.JudgeRegulation, testinfo.TestAcc.CellVolChkAcc, out TestStatus[num]);
                                        ShowLog("循环" + (loop + 1) + "设备测试结束");
                                        ShowProgress(pb);
                                        //if (TestStatus[num])
                                        //{
                            ...
                            if (!HasValueGreaterThanThreshold(CurItems, nameToValueMap[SplitItems[1]]))
                            {
                                ...
                                for (int num = 0; num < CurItems.Length; num++)
                                {
                                    ...
                                    for (int loop = 0; loop < Convert.ToInt16(SplitItems[3]); loop++)
                                    {
                                        ...
                                        ShowLog("循环" + (loop + 1) + "设备测试中...");
                                        checkTest.ReadCellCurrent(testinfo.DeviceType, testinfo.BoxNum, Convert.ToInt32(CurItems[num]), testinfo.JudgeRegulation, testinfo.TestAcc.CellCurChkAcc, out TestStatus[num]);
                                        ShowLog("循环" + (loop + 1) + "设备测试结束");
                            ...
                            if (!HasValueGreaterThanThreshold(SMCItems, nameToValueMap[SplitItems[1]]))
                            {
                                ...
                                for (int num = 0; num < SMCItems.Length; num++)
                                {
                                    ...
                                    for (int loop = 0; loop < Convert.ToInt16(SplitItems[3]); loop++)
                                    {
                                        ...
                                        ShowLog("循环" + (loop + 1) + "设备测试中...");
                                        checkTest.ReadLVVoltage(testinfo.DeviceType, testinfo.BoxNum, Convert.ToInt32(SMCItems[num]), testinfo.JudgeRegulation, testinfo.TestAcc.LoadPartVolChkAcc, out TestStatus[num]);
                                        ShowLog("循环" + (loop + 1) + "设备测试结束");
                                        ShowProgress(pb);
                                        //if (TestStatus[num])
                                        //{
                            ...
                            if (!HasValueGreaterThanThreshold(CurItems, nameToValueMap[SplitItems[1]]))
                            {
                                ...
                                for (int num = 0; num < CurItems.Length; num++)
                                {
                                    ...
                                    for (int loop = 0; loop < Convert.ToInt16(SplitItems[3]); loop++)
                                    {
                                        ...
                                        ShowLog("循环" + (loop + 1) + "设备测试中...");
                                        checkTest.ReadLVCurrent(testinfo.DeviceType, testinfo.BoxNum, Convert.ToInt32(CurItems[num]), testinfo.JudgeRegulation,testinfo.TestAcc.LoadPartCurChkAcc, out TestStatus[num]);
                                        ShowLog("循环" + (loop + 1) + "设备测试结束");
                            ...
                            if (!HasValueGreaterThanThreshold(SMCItems, nameToValueMap[SplitItems[1]]))
                            {
                                ...
                                for (int num = 0; num < SMCItems.Length; num++)
                                {
                                    ...
                                    for (int loop = 0; loop < Convert.ToInt16(SplitItems[3]); loop++)
                                    {
                                        ...
                                        checkTest.ReadStaticCurrent(testinfo.DeviceType, testinfo.BoxNum, SplitItems[1], Convert.ToInt32(SMCItems[num]), testinfo.CurAcc, CutRange, out TestStatus[num]);
                            ...
                            if (!HasValueGreaterThanThreshold(SMCItems, nameToValueMap[SplitItems[1]]))
                            {
                                ...
                                for (int num = 0; num < SMCItems.Length; num++)
                                {
                                    ...
                                    for (int loop = 0; loop < Convert.ToInt16(SplitItems[3]); loop++)
                                    {
                                        ...
                                        checkTest.ReadStaticCurrent(testinfo.DeviceType, testinfo.BoxNum, SplitItems[1], Convert.ToInt32(SMCItems[num]), testinfo.TestAcc.StCur_1000nAChkAcc, CutRange, out TestStatus[num]);
                            ...
                            if (!HasValueGreaterThanThreshold(SMCItems, nameToValueMap[SplitItems[1]]))
                            {
                                ...
                                for (int num = 0; num < SMCItems.Length; num++)
                                {
                                    ...
                                    for (int loop = 0; loop < Convert.ToInt16(SplitItems[3]); loop++)
                                    {
                                        ...
                                        ShowLog("循环" + (loop + 1) + "设备测试中...");
                                        checkTest.ReadPinVoltage(testinfo.DeviceType, testinfo.BoxNum, Convert.ToInt32(SMCItems[num]), "SDA", testinfo.JudgeRegulation, testinfo.TestAcc.PortVolt_ChkAcc, out TestStatus[num]);
                                        ShowLog("循环" + (loop + 1) + "设备测试结束");
                                        ShowProgress(pb);
                                        //if (TestStatus[num])
                                        //{
