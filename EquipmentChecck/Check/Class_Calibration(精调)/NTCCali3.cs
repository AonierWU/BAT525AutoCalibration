...
namespace TestSystem_Pack
{
    ...
    {
        public bool NTCCali3(string Box, double NtcCaliAcc, double NtcCheckAcc, string CurAccResRegulation, string CheckType, string DeviceType,  bool CaliType,  out string Point)
        {
           ...
           // int rate = 0;
            ...
            {
                case "BAT525G":
                    int[] s = new int[] { 20000, 50000, 100000, 150000, 200000 };
                    ...
                    break;
                case "BAT525H":
                    int[] h = new int[] { 20000, 50000, 100000, 150000, 200000 };
                    ...
                    break;
                case "BAT525C":
                    int[] c = new int[] { 10000, 20000, 30000, 40000, 60000, 80000, 100000 };
                    CaliValue.AddRange(c);
                  
                    Vol_ADC_Add_L = new int[7];//存放DAC设置值的低地址
                    for (int j = 0; j < 7; j++)
                    {
                        Vol_ADC_Add_L[j] = 0x7F + j * 3;// addr
                    }
                    break;
                case "BAT525D":
                    int[] d = new int[] { 10000, 20000, 30000, 40000, 60000, 80000, 100000 };
                ...
                if (!StopStatus)
                {
                    ...
                    for (int s = 0; s < CaliValue.Count; s++)
                    {
                        ...
                        if (!StopStatus)
                        {
                            ...
                            if (DeviceType == "BAT525C" || DeviceType == "BAT525D")
                            {
                                if (Math.Abs((Volt2DH2 * 65536 + Volt2DH * 256 + Volt2DL) - (VoltDH2 * 65536 + VoltDH * 256 + VoltDL)) <= 256)
                                {
