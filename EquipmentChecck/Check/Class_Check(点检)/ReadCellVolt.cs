...
namespace TestSystem_Pack
{
    public partial class CheckItem
    {
        ...
        public void ReadCellVoltage(string DeviceType, string TesterID, int intSetVolt, string judge, double VoltAcc, out bool isNG, bool WriteExcel)
        {
